    ...
    [[imNWManager sharedNWManager] sendMessage:message withResponse:^(NSString *responseString, NSData *responseData) {
        ...
        if (err) {
            ...
            if (errorcode == 0) {
                ...
                NSError *error = [NSError errorWithDomain:PATH__FRIEND_FOCUS_LIST_ code:errorcode userInfo:userInfo];
                [[NSNotificationCenter defaultCenter] postNotificationName:NOTI__FRIEND_FOCUS_LIST_ object:error];
            }
        }
    }];
}
