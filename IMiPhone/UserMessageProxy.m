...
- (void)sendTypeSearch:(NSString *)oid
{
    ...
    [[IMNWManager sharedNWManager] sendMessage:message withResponse:^(NSString *responseString, NSData *responseData) {
        ...
        if (err) {
            ...
            int errorcode = [[json objectForKey:KEYP_H__USER_SEARCH__ERROR_CODE] intValue];
            if (errorcode == 0) {
                ...
                [self processErrorCode:errorcode fromSource:PATH_H__USER_SEARCH_ useNotiName:NOTI_H__USER_SEARCH_];
            }
